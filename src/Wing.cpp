...
void Wing::UpdateStates(	double body_velocity_roll,
...
void Wing::UpdateVelocitySquaredCoeff()
{
...
void Wing::UpdateCenterOfPressure()
{
	d_cp_ = d_cp(alpha_);
}

/*
void Wing::UpdateMomentCoeff()
{
